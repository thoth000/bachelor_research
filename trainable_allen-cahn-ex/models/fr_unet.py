...
class Allen_Cahn_Model(nn.Module):
    ...
    def allen_cahn_ex(self, u, ex):
        ...
        return self.M * (laplacian - (u*(1-u)*(2*u-1)) + ex)
    ...
    def forward(self, x):
        ...
        for _ in range(self.steps):
            ...
            k1 = self.allen_cahn_ex(x, ex)
            k2 = self.allen_cahn_ex(x + self.dt/2 * k1, ex)
            k3 = self.allen_cahn_ex(x + self.dt/2 * k2, ex)
            k4 = self.allen_cahn_ex(x + self.dt * k3, ex)
